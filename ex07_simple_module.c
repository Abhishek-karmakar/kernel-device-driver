...
*/
ssize_t ex07_read (struct file *, char __user *, size_t, loff_t *);
ssize_t ex07_write (struct file *, const char __user *, size_t, loff_t *);
int ex07_open (struct inode *, struct file *);
int ex07_close (struct inode *, struct file *);
